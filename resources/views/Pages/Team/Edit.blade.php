            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select name="ketua_tim" class="form-control select2bs4 @error('ketua_tim') is-invalid @enderror"
                     style="width: 100%;">
                     <option selected value="{{ $team->ketua_tim }}">{{ $team->user->username }}</option>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nama_team') is-invalid @enderror" id="nama_team"
                     name="nama_team" placeholder="masukkan nama tim" value="{{ old('nama_team', $team->nama_team) }}">
                  @error('nama_team')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
               </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('tugas') is-invalid @enderror" id="tugas" name="tugas"
                     placeholder="Masukkan tugas dari tim" value="{{ old('tugas', $team->tugas) }}">
                  @error('tugas')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
               </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('jumlah_anggota') is-invalid @enderror"
                     ...
                     value="{{ old('jumlah_anggota', $team->jumlah_anggota) }}">
