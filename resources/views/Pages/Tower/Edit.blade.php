...
<li class="breadcrumb-item active" aria-current="page">Edit-Tower</li>
@endsection
{{-- Breadcrumb --}}
...
<div class="card card-default">
   ...
   <!-- /.card-header -->
   <form action="{{ route('tower.update', $tower->id) }}" method="POST" enctype="multipart/form-data">
      @method('PUT')
      @csrf
      <div class="card-body">
         <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nama_tower') is-invalid @enderror" id="nama_tower"
                     ...
                     value="{{ old('nama_tower', $tower->nama_tower) }}">
                  @error('nama_tower')
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('lokasi_tower') is-invalid @enderror" id="lokasi_tower"
                     ...
                     value="{{ old('lokasi_tower', $tower->lokasi_tower) }}">
                  @error('lokasi_tower')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
               </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('latitude') is-invalid @enderror" id="latitude"
                     name="latitude" value="{{ old($tower->latitude, $tower->latitude) }}"
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('longtitude') is-invalid @enderror" id="longtitude"
                     name="longtitude" value="{{ old($tower->longtitude, $tower->longtitude) }}"
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select name="status_tower" class="form-control @error('status_tower') is-invalid @enderror"
                     style="width: 100%;">
                     @if ($tower->status_tower === 'aktif')
                     <option selected value="aktif">Aktif</option>
                     <option value="maintenance">Maintenance</option>
                     <option value="nonaktif">Nonaktif</option>
                     @elseif ($tower->status_tower === 'maintenance')
