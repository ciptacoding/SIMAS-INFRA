            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select name="jenis_laporan"
                     ...
                     <option selected value="sparepart">Sparepart</option>
                     <option value="requestMaintenance">Request Maintenance</option>
                     <option value="lokasi">Lokasi Tower</option>
                     <option value="team">Data Team</option>
                     @break
                     ...
                     <option value="maintenance">Maintenance</option>
                     <option value="sparepart">Sparepart</option>
                     <option selected value="requestMaintenance">Request Maintenance</option>
                     <option value="lokasi">Lokasi Tower</option>
                     <option value="team">Data Team</option>
                     @break
                     ...
                     <option value="sparepart">Sparepart</option>
                     <option value="requestMaintenance">Request Maintenance</option>
                     <option selected value="lokasi">Lokasi Tower</option>
                     <option value="team">Data Team</option>
                     @break
                     ...
                     <option value="requestMaintenance">Request Maintenance</option>
                     <option value="lokasi">Lokasi Tower</option>
                     <option selected value="team">Data Team</option>
                     @break
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul"
                     placeholder="Masukkan judul dari laporan" value="{{ old('judul', $laporan->judul) }}">
                  @error('judul')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
               </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                     name="tanggal" placeholder="Masukkan tanggal" value="{{ old('tanggal', $laporan->tanggal) }}">
                  @error('tanggal')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
               </div>
